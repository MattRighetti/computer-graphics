...
function drawScene() {
	...
	projectionMatrix = utils.multiplyMatrices(parProjectionMatrix, utils.multiplyMatrices(viewMatrix, utils.multiplyMatrices(utils.MakeTranslateMatrix(-7,0,0),utils.MakeScaleMatrix(10))));
